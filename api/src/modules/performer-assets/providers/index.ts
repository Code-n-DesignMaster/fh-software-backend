...
import {
  VideoSchema, GallerySchema, PhotoSchema, ProductSchema, MediaLirarySchema
} from '../schemas';
...
export const PERFORMER_MEDIA_IMPORT_MODEL_PROVIDER = 'PERFORMER_MEDIA_IMPORT_MODEL_PROVIDER';
...
export const assetsProviders = [
  ...
  {
    provide: PERFORMER_MEDIA_IMPORT_MODEL_PROVIDER,
    useFactory: (connection: Connection) => connection.model('MediaLirary', MediaLirarySchema),
    inject: [MONGO_DB_PROVIDER]
  }
];
